    ...
    <div class="container mt-3">
        ...
        <div class="row mt-3">
            <div class="col-sm">
                ...
                <asp:TextBox ID="TextBox2" runat="server" TextMode="Number" step="0.01" CssClass="form-control"></asp:TextBox>
            </div>
            <div class="col-sm">
                <asp:Label ID="Label7" runat="server" Text="Estatura (m)"></asp:Label>
                <asp:TextBox ID="TextBox3" runat="server" TextMode="Number" step="0.01" CssClass="form-control"></asp:TextBox>
            </div>
            <div class="col-sm">
        ...
        <div class="mt-3">
            ...
            <asp:Button ID="btnRegistro" CssClass="btn btn-primary" runat="server" Text="Guardar"/> <br />
        </div>
    </div>
</asp:Content>
